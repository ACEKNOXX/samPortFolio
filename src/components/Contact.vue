                ...
                <div class="columns">
                    <div class="column ">
                        <div class="column  has-text-light ">
                            <a href="#" class="has-text-success "> <i class="fab fa-medium fa-2x"></i> @Sam okediji</a>
                        </div>
                        <div class="column has-text-light ">
                            <a href="#" class="has-text-link   "> <i class="fab fa-twitter-square fa-2x"></i>  @Sam okediji</a>
                        </div>
                        <div class="column has-text-light ">
                            <a href="#" class="has-text-black-ter has-text-grey-lighter  "> <i class="fab fa-github-square fa-2x"></i> @sam okediji </a>
                        </div>
                        <div class="column has-text-light ">
                        ...
                        <div class=" column is-three-fifths section-bodying">
                            ...
                            <div class="field">
                                <label class="label has-text-grey-lighter">Message</label>
                                <div class="control">
